...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    langToggle.addEventListener("click", function (e) {
      ...
      var currentLang = langToggle.textContent.trim().toLowerCase();
      var newLang = currentLang === "(es)" ? "(en)" : "(es)";
      langToggle.textContent = newLang;

      // Obtener la URL actual después del cambio de idioma
      var newUrl = currentUrl.includes("/es/")
        ? currentUrl.replace("/es/", "/en/")
        : currentUrl.replace("/en/", "/es/");
